...
document.getElementById("bold_button").onclick=()=>{
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand("bold", false, null);
...
document.getElementById("orderList_button").onclick=()=>{
    if(isSelectionTag("OL")){
        ...
        document.getElementById("iframeTextEdit").contentWindow.document.execCommand("insertOrderedList", false, null);
    }
    iframeBody.focus();
    showCodeSource();
}
...
document.getElementById("unorderedList_button").onclick=()=>{
    if(isSelectionTag("UL")){
        ...
        document.getElementById("iframeTextEdit").contentWindow.document.execCommand("insertUnorderedList", false, null);
    }
    iframeBody.focus();
    showCodeSource();
}
...
document.getElementById("underline_button").onclick=()=>{
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand("underline", false, null);
    document.getElementById("underline_button").classList.toggle("active");
    iframeBody.focus();
}
// italic text
document.getElementById("italic_button").onclick=()=>{
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand("italic", false, null);
    document.getElementById("italic_button").classList.toggle("active");
    iframeBody.focus();
}
// last and next action
function doUndo(){
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand('undo', false, null);
    iframeBody.focus();
}
function doRedo(){
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand('redo', false, null);
    iframeBody.focus();
}
// change color
function changeColor(){
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand("foreColor", false, document.getElementById("txtColorSelector").value);
    iframeBody.focus();
}
// change text size
function changeSize(){
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand("fontSize", false, document.getElementById("txtSizeSelector").value);
    iframeBody.focus();
}
// show code source
...
iframeBody.addEventListener("paste", function(e) {
    ...
    document.getElementById("iframeTextEdit").contentWindow.document.execCommand("insertHTML", false, pastext);
});
...
function textRight(){
    if(isSelectionAlign("right")){
        ...
        document.getElementById("iframeTextEdit").contentWindow.document.execCommand("JustifyRight", false, null);
        document.getElementById("button_alignRight").classList.add("active");
        document.getElementById("button_alignLeft").classList.remove("active");
        document.getElementById("button_alignCenter").classList.remove("active");
    }
...
function textLeft(){
    if(isSelectionAlign("left")){
        ...
        document.getElementById("iframeTextEdit").contentWindow.document.execCommand("JustifyLeft", false, null);
        document.getElementById("button_alignRight").classList.remove("active");
        document.getElementById("button_alignLeft").classList.add("active");
        document.getElementById("button_alignCenter").classList.remove("active");
    }
...
function textCenter(){
    if(isSelectionAlign("center")){
        ...
        document.getElementById("iframeTextEdit").contentWindow.document.execCommand("JustifyCenter", false, null);
        document.getElementById("button_alignRight").classList.remove("active");
        document.getElementById("button_alignLeft").classList.remove("active");
        document.getElementById("button_alignCenter").classList.add("active");
    }
...
function buttoncolorText(){
    document.getElementById("txtColorBtn").style.color = document.getElementById("txtColorSelector").value;
}
